# Run Cypress v10 Accessibility Tests on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can run Cypress v10 accessibility tests using the TestMu AI Accessibility Tool. This sample shows how to configure Cypress v10 + TestMu AI Accessibility to run on the TestMu AI cloud.
...
- Cypress v10: `npm install cypress@10`
...
```bash
git clone https://github.com/LambdaTest/lambdatest-accessibility-cypress-v10 && cd lambdatest-accessibility-cypress-v10
npm install
```
